...
public class DirectoryChooserDialog2
{
    ...
    public DirectoryChooserDialog2(Context context, String file_select_type, SimpleFileDialogListener SimpleFileDialogListener)
    {
                                                             ...
                                                             OnClickListener onClickListener)
    {
        ...
        if (Select_type == FileOpen    ) m_titleView1.setText("Select your audiobooks folder:");
